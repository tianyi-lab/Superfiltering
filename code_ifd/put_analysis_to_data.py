...
def parse_args():
    ...
    parser.add_argument("--pt_data_path", type=str, default='alpaca_data_gpt2_scores.jsonl')
    parser.add_argument("--json_data_path", type=str, default='data/alpaca_data.json')
    parser.add_argument("--json_save_path", type=str, default='alpaca_data_gpt2_data.json')
